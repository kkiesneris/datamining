...
getFraudData = """
    select degraded_pan, tran_date, amount, term_id, merchant_name, merchant_city, arn
    from mc_acq
...
for fRow in fraudCursor.execute(getFraudData):
    ...
    getAtmTrans = """
            ...
            and amt_1 = :2
            and term_term_id = :3
            and term_owner_name = :4
            and tran_datetime = to_date(:5,'YYYYMMDDHH24MISS')
    """
    ...
    tranCursor.execute(getAtmTrans,(fPAN,fAmount,fTerminalId,fMerchantName,fTranDate))
